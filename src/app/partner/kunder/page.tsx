...
// Partner's own customers (Aktiv Handyman)
const partnerCustomers = [
  {
    ...
    postalCode: '2000',
    city: 'Lillestrøm',
    phone: '+47 66 93 80 00',
    email: 'post@lillestrom.kommune.no',
    contactPerson: 'Helse- og omsorgsavdelingen',
    activeOrders: 3,
  },
  {
    id: 'AH-2',
    name: 'Skedsmo Hjelpemiddellager',
    type: 'leverandor',
    address: 'Industriveien 22',
    postalCode: '2020',
    city: 'Skedsmokorset',
    phone: '+47 67 92 10 00',
    email: 'lager@skedsmo-hm.no',
    contactPerson: 'Lagersjef Terje Olsen',
    activeOrders: 1,
  },
  {
    id: 'AH-3',
    name: 'NAV Hjelpemiddelsentral Akershus',
    type: 'nav',
    address: 'Schweigaardsgate 15',
    postalCode: '0191',
    city: 'Oslo',
    phone: '+47 55 55 33 33',
    email: 'nav.hjelpemidler.akershus@nav.no',
    contactPerson: 'Rådgiver Morten Haugen',
    activeOrders: 5,
  },
  {
    id: 'AH-4',
    name: 'Privat - Familie Hansen',
    type: 'privat',
    address: 'Granveien 15',
    postalCode: '2010',
    city: 'Strømmen',
    phone: '+47 90 12 34 56',
    email: 'hansen.familie@gmail.com',
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">{partnerCustomers.length} registrerte kunder</p>
        </div>
        <Button>
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-3 pt-3 border-t border-gray-100 flex items-center justify-between">
                  <p className="text-xs text-gray-500">
                    Kontakt: <span className="font-medium text-gray-700">{customer.contactPerson}</span>
                  </p>
                  <span className="text-xs text-brand font-medium">
                    {customer.activeOrders} aktive ordrer
                  </span>
                </div>
              </div>
            </div>
