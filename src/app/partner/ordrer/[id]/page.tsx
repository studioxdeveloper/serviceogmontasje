...
const getLogHistory = (orderId: string) => [
  { id: '1', timestamp: '2026-02-03 09:15', action: 'Status endret til Påbegynt', user: 'Kari Nordmann', type: 'status' },
  { id: '2', timestamp: '2026-02-02 14:30', action: 'Tekniker tildelt: Kari Nordmann', user: 'Jan Nordmann', type: 'assign' },
  { id: '3', timestamp: '2026-02-01 10:00', action: 'Oppdrag mottatt fra Service og Montasje', user: 'System', type: 'create' },
]
...
export default function PartnerOrderDetailPage() {
  ...
  const order = orders.find(o => o.id === params.id && o.partnerId === PARTNER_ID)
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          {order.technicianNotes && (
            <Card className="p-6">
              <h2 className="font-heading font-semibold text-brand-dark mb-4">Teknikernotater</h2>
              <p className="text-gray-700 bg-brand-bg p-4 rounded-xl">{order.technicianNotes}</p>
            </Card>
          )}
          ...
          <Card className="p-6">
            ...
            {technician ? (
              ...
              <div className="space-y-2">
                ...
                <select className="w-full px-3 py-2.5 bg-gray-50 rounded-xl border-0 text-sm focus:ring-2 focus:ring-brand/20">
