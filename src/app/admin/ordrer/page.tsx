...
export default function AdminOrdersPage() {
  ...
  const allOrders = getOrdersVisibleToSM()
  ...
  const activePartners = partners.filter(p => !p.isMain)
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-4 py-2.5 bg-gray-50 rounded-xl border-0 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-brand/20"
            >
              <option value="all">Alle partnere</option>
          ...
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-gray-100">
              <tr>
                ...
                <th className="text-left px-6 py-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">Partner</th>
