...
import { getOrdersVisibleToSM, technicians, partners, statusLabels } from '@/data/mockData'
import { 
  ChevronLeft, 
  ChevronRight, 
  Plus,
...
export default function AdminCalendarPage() {
  ...
  const getOrdersForDate = (day: number) => {
    ...
    return orders.filter(o => o.scheduledDate === dateStr)
  }
  
  // Get orders for selected date
  const selectedOrders = selectedDate 
    ? orders.filter(o => o.scheduledDate === selectedDate)
    : []
        ...
        <Card className="p-6">
          ...
          <div className="mt-6 pt-4 border-t border-gray-100">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded bg-brand-light/30" />
                <span className="text-xs text-gray-600">Påbegynt</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded bg-gray-100" />
                <span className="text-xs text-gray-600">Uåpnet/Planlagt</span>
              </div>
            </div>
          </div>
        </Card>
